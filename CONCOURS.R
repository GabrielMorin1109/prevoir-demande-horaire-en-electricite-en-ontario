...
for(i in 11:14){
  ...
  system.time({
    ...
    test1 <- readRDS("Random_Forest_mdel/model6_1_4.rds")
    test2 <- readRDS("Random_Forest_mdel/model6_5_10.rds")
    test3 <- readRDS("Random_Forest_mdel/model6_11.rds")
    test4 <- readRDS("Random_Forest_mdel/model6_12_13_14.rds")
RF <- c(test1[1:4],test2[5:10],test3[1], test4[12:14])
RF
##################################################################################
##################################################################################
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
